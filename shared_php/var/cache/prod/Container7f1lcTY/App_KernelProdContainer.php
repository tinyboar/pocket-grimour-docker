...
class App_KernelProdContainer extends Container
{
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('kernel.request', [0 => function () {
            return ($this->privates['App\\EventListener\\LocaleSubscriber'] ?? ($this->privates['App\\EventListener\\LocaleSubscriber'] = new \App\EventListener\LocaleSubscriber()));
        }, 1 => 'onKernelRequest'], 0);
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('dbLNReClU+', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
